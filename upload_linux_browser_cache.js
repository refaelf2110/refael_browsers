...
/**
 * upload_linux_browser_cache.js
 *
 * Uploads the local linux-browser-cache/ directory to s3://refael-browsers-cache/linux/
 * maintaining the same folder structure.
 *
 * Usage:
 *   node upload_linux_browser_cache.js
 *
...
const SOURCE_DIR = path.join(__dirname, 'linux-browser-cache');
...
(async () => {
  ...
  console.log('Listing existing linux S3 objects...');
